...
# 构建与调试`rustc`  (Building and debugging `rustc`)

- [如何构建和运行 Rust 编译器](./building/how-to-build-and-run.md)
...
[附录 A: Background topics](./appendix/background.md)
[附录 B: Glossary](./appendix/glossary.md)
[附录 C: Code Index](./appendix/code-index.md)
[附录 D: Compiler Lecture Series](./appendix/compiler-lecture.md)
[附录 E: Bibliography](./appendix/bibliography.md)

[附录 Z: HumorRust](./appendix/humorust.md)
